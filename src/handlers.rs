...
pub async fn patch(entity_id: &str, patches: Json<Vec<Patch>>, pool: &State<bb8::Pool<bb8_redis::RedisConnectionManager>>) -> Result<(), String> {
...
pub async fn delete(entity_id: &str, pool: &State<bb8::Pool<bb8_redis::RedisConnectionManager>>) -> Result<(), String> {
  ensure_valid_entity_id(entity_id)?;
...
pub async fn view(entity_id: &str, views: Json<Vec<View>>, pool: &State<bb8::Pool<bb8_redis::RedisConnectionManager>>) -> Result<ViewResponse, String> {
  ensure_valid_entity_id(entity_id)?;
